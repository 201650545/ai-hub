...
ENGINES = {
    ...
    "kimi": {
        ...
        "dismiss_popup_js": "(function(){ var btns=Array.from(document.querySelectorAll('button, div[role=button]')); for(var i=0;i<btns.length;i++){ if((btns[i].innerText||'').indexOf('稍<ctrl42>后再说')>-1){ btns[i].click(); return true; } } return false; })()",
